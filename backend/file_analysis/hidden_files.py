# To recursively search for files in a directory which are marked as hidden, preventing users from finding the file in search results or without enabling 'show hidden files' in file explorer

# backlog: getting this thing to read from images in filesystem.py 
...
directory_to_search = r"C:\Users\txvpa\OneDrive - Swinburne University\University\2024_Semester2\Swinburne\COS40006_ComputingTechnologyProjectB\forensics_testfiles" # Can be swapped out to a dynamic variable
